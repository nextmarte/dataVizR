...
(a) No DataFrame dados_atmosfera, identifique duas variáveis categóricas. Liste cinco exemplos de valores únicos para uma das variáveis categóricas.

(b) Escolha uma variável contínua  (por exemplo, "temperatura") e gere um histograma para visualizar a distribuição dessa variável.
